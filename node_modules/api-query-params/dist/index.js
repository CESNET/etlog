...
exports.default = function (rawQuery = '', options = {}) {
  const result = {};
  const query = typeof rawQuery === 'string' ? _querystring2.default.parse(rawQuery) : rawQuery;
...
function getFilter(filter, query, options) {
  ...
  return Object.keys(query).map(val => {
