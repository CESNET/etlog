...
exports.default = function () {
  ...
  operators.forEach(function (_ref3) {
    var operator = _ref3.operator;
    var method = _ref3.method;
    var defaultKey = _ref3.defaultKey;
...
function parseUnaries(unaries) {
  var values = arguments.length <= 1 || arguments[1] === undefined ? { plus: 1, minus: -1 } : arguments[1];
...
function getFilter(filter, query, options) {
  ...
  return Object.keys(query).filter(function (val) {
    return options.blacklist.indexOf(val) === -1 && (!options.whitelist || options.whitelist.indexOf(val) !== -1);
    ...
    var _op = _join$match2[3];
    var _value = _join$match2[4];


    var value = parseValue(_value);
    var op = parseOperator(_op);
