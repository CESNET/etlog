...
{ current_stats: { fail: [ 0, 8, 1, 0 ], ok: [ 0, 0, 0, 0 ] },
  ...
  avg_ratio_current_to_old: { ok: 0, fail: 9 },
  old_ok_fail_ratio: [ 0, 1, 0, 0 ],
  current_ok_fail_ratio: [ 8 ],
  old_fail_sd: 0.4330127018922193,
  current_fail_sd: 3.344772040064913 }

student.ujak.cz
{ current_stats: { fail: [ 35, 23, 2, 54 ], ok: [ 21, 2, 5, 7 ] },
  current_avg_stats: { ok: 8.75, fail: 28.5 },
  current_day_stats: { ok: [ 7 ], fail: [ 54 ] },
  old_stats: { fail: [ 2, 46, 35, 23 ], ok: [ 5, 8, 21, 2 ] },
  old_avg_stats: { ok: 9, fail: 26.5 },
  avg_ratio_current_to_old: { ok: 0.9722222222222222, fail: 1.0754716981132075 },
  old_ok_fail_ratio: [ 0.4, 5.75, 1.6666666666666667, 11.5 ],
  current_ok_fail_ratio: [ 7.714285714285714 ],
  old_fail_sd: 16.31716887208072,
  current_fail_sd: 18.874586088176873 }
...
{ current_stats: { fail: [ 3, 266, 2, 1 ], ok: [ 347, 395, 238, 62 ] },
  ...
  avg_ratio_current_to_old: { ok: 1.1180257510729614, fail: 6.9743589743589745 },
  old_ok_fail_ratio:
  [ 0.008645533141210375,
  0.11578947368421053,
  0.008403361344537815,
  0.016129032258064516 ],
  current_ok_fail_ratio: [ 0.6734177215189874 ],
...
{ current_stats: { fail: [ 317, 27, 87, 116 ], ok: [ 964, 251, 454, 700 ] },
  ...
  avg_ratio_current_to_old: { ok: 1.1928499496475327, fail: 2.260330578512397 },
  old_ok_fail_ratio:
  [ 0.020654044750430294,
  0.19162995594713655,
  0.1657142857142857,
  0.10756972111553785 ],
  current_ok_fail_ratio: [ 0.3288381742738589 ],
...
{ current_stats: { fail: [ 5, 12, 5, 2 ], ok: [ 63, 45, 107, 27 ] },
  ...
  avg_ratio_current_to_old: { ok: 0.7034883720930233, fail: 1.8461538461538463 },
  old_ok_fail_ratio:
  [ 0.07936507936507936,
  0.006802721088435374,
  0.04672897196261682,
  0.07407407407407407 ],
  current_ok_fail_ratio: [ 0.26666666666666666 ],
...
{ current_stats: { fail: [ 1, 0, 1, 0 ], ok: [ 9, 18, 3, 0 ] },
  ...
  avg_ratio_current_to_old: { ok: 0.5882352941176471, fail: 2 },
  old_ok_fail_ratio: [ 0, 0.1111111111111111, 0, 0 ],
  current_ok_fail_ratio: [ 0.3333333333333333 ],
  old_fail_sd: 0.4330127018922193,
  current_fail_sd: 0.5 }
...
{ current_stats: { fail: [ 16, 0, 3, 2 ], ok: [ 395, 210, 674, 233 ] },
  ...
  avg_ratio_current_to_old: { ok: 1.0106951871657754, fail: 3.5 },
  old_ok_fail_ratio:
  [ 0.002638522427440633,
  0.004451038575667656,
  0.008583690987124463,
  0 ],
  current_ok_fail_ratio: [ 0.04050632911392405 ],
...
{ current_stats: { fail: [ 15, 141, 10, 0 ], ok: [ 33, 19, 46, 0 ] },
  ...
  avg_ratio_current_to_old: { ok: 1.1951219512195121, fail: 6.64 },
  old_ok_fail_ratio: [ 0, 0.45454545454545453, 0.21739130434782608, 0 ],
  current_ok_fail_ratio: [ 7.421052631578948 ],
...
{ current_stats: { fail: [ 0, 1, 6, 5 ], ok: [ 36, 20, 25, 18 ] },
  ...
  avg_ratio_current_to_old: { ok: 1.010204081632653, fail: 2 },
  old_ok_fail_ratio: [ 0, 0.05, 0, 0.2777777777777778 ],
  current_ok_fail_ratio: [ 0.24 ],
...
{ current_stats: { fail: [ 54, 2, 70, 1 ], ok: [ 286, 456, 207, 15 ] },
  ...
  avg_ratio_current_to_old: { ok: 0.9163498098859315, fail: 2.1166666666666667 },
  old_ok_fail_ratio:
  [ 0.010169491525423728,
  0.0043859649122807015,
  0.1888111888111888,
  0.06666666666666667 ],
  current_ok_fail_ratio: [ 0.33816425120772947 ],
...
{ current_stats: { fail: [ 19, 257, 26, 11 ], ok: [ 39, 70, 17, 28 ] },
  ...
  avg_ratio_current_to_old: { ok: 1.8333333333333333, fail: 5.589285714285714 },
  old_ok_fail_ratio:
  [ 0,
  0.48717948717948717,
  1.5294117647058822,
  0.39285714285714285 ],
  current_ok_fail_ratio: [ 3.6714285714285713 ],
...
{ current_stats: { fail: [ 2, 2, 84, 2 ], ok: [ 36, 65, 87, 91 ] },
  ...
  avg_ratio_current_to_old: { ok: 1.1923076923076923, fail: 6.923076923076923 },
  old_ok_fail_ratio:
  [ 0.16666666666666666,
  0.05555555555555555,
  0.03076923076923077,
  0.02197802197802198 ],
  current_ok_fail_ratio: [ 0.9655172413793104 ],
